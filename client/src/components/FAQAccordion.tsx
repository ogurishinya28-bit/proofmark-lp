...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "はい。ProofMarkは「ダイレクトアップロード」を採用しています。作品ファイルはVercelサーバーを経由せず、強固なセキュリティを持つSupabase Storageへ直接転送されます。転送後にサーバーサイドでハッシュ計算を行い、計算後は速やかに処理されます。あなたの作品とプライバシーは厳重に保護されます。",
  },
  {
  ...
  {
    id: "about-copyright",
    question: "ProofMarkを使うと著作権が発生するのですか？", // 【新規追加】本質的な価値
  ...
  },
  {
    ...
    question: "証明書をPDFでダウンロードできますか？", // 【復活】
  ...
  },
  {
    ...
    question: "クライアントにどう説明すればいいですか？", // 【復活】
