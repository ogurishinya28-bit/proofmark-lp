...
画像や作品データについては、ブラウザ内でSHA-256ハッシュ値を計算するため、サーバーへの送信は一切行いません。
...
最終更新：2026年3月`,
      whyMatters:
        "ProofMarkは「Privacy by Design」を設計の根幹に置いています。あなたの作品データをサーバーに送ることなく、ハッシュ値のみで権利証明を実現するため、個人情報のリスクを最小化しています。",
      sources: [
        {
